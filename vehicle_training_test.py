...
def main():
    ...
    agent = VehicleAgent(MultiVehicleEnv, sim_kwargs, agent_name='ppo', total_time_steps=2000000, load_model_dir='./RL/training/logs/PPO16/checkpoint_log/vehicle_rl_ppo_20250507-0230_1550000_steps')
    agent.learn()
